---
description: Git操作を自動化（add, commit, push）
allowed-tools: Bash(git:*), Bash(git add:*), Bash(git commit:*), Bash(git push:*), Bash(git pull:*), Bash(git status:*), Bash(git diff:*), Bash(git log:*)
---
